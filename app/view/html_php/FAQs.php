...
<body>
  <header class="headContact">
    <br>
    <h1 id="titulo" class="animate__animated animate__backInLeft">Bienvenidos a Nuestro Espacio de Preguntas Frecuentes<img src="../../media/images/mujer.png" alt="pregunta" style="padding-left: 40px;"></h1>
    <hr>
  </header>
