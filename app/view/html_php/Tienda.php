    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="../../media/images/Carrusel2.jpg " alt="First slide" width="auto" height="500">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="../../media/images/Carrusel3.png" alt="Second slide" width="auto" height="500">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="../../media/images/Carrusel1.webp" alt="Third slide" width="auto" height="500">
            </div>
        </div>
